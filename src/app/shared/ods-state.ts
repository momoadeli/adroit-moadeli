...
/* 
  ...
  concept: 
    ...
    Key is this state can run within the liecycle of the client smart component and doesn't need to usurp global memory unlike an
  ...
  intent: 
    ...
    etc. Additionally an ODS state cab be easily promoted to a global ngRx slice once and if needed.
    As a service, it can be injected into any component.It can also be overridden
    using Angular's DI mechanism in case an alternative implementation is needed.
*/
